                            ...
                            value: function () {
                                (0, a.default)(".js-product-miniature").each(function (t, e) {
                                    ...
                                    n.length &&
                                        ...
                                        n.css("top", -(0, a.default)(e).find(".thumbnail-container").height() + (0, a.default)(e).find(".product-description").height() + 10),
                    ...
                    function v() {
                        L.on("touchspin.uponce", function () {
                            ...
                            L.on("touchspin.updatesettings", function (t, e) {
                                console.log("k3n :: touchspin.updatesettings");
                                s(e);
                            });
                    }
                    function y(t) {
